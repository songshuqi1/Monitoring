...
.stepper-btn { min-width:0; min-height:0; border:0; border-right:1px solid rgba(100,116,139,.45); background:linear-gradient(180deg,rgba(255,255,255,.92),rgba(226,232,240,.86)); color:#111827; font-family:var(--font-family); font-size:clamp(12px,32%,18px); font-weight:800; cursor:pointer; }.stepper-btn:last-child { border-right:0; border-left:1px solid rgba(100,116,139,.45); }.stepper-btn:hover:not(:disabled) { filter:brightness(1.05); }.stepper-btn:active:not(:disabled) { transform:translateY(1px); }
.stepper-value { min-width:0; display:flex; align-items:center; justify-content:center; gap:4px; padding:0 6px; background:linear-gradient(180deg,rgba(255,255,255,.88),rgba(226,232,240,.78)); font-family:var(--font-family); }.stepper-number { min-width:0; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; font-size:clamp(11px,28%,16px); font-weight:800; color:#0f172a; }.stepper-unit { flex:0 0 auto; font-size:clamp(10px,22%,13px); font-weight:700; color:#475569; }
